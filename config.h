...
/* tagging */
static const char *tags[] = { "terminal", "browser", "chat", "git", "keeweb", "VI", "VII", "VIII", "IX" };
...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|ControlMask,           KEY,      toggleview,     {.ui = 2 << TAG} }, \
...
static const char *termcmd[]  = { "dbus-launch", "gnome-terminal", "--zoom=0.8", NULL };
